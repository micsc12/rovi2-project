...
public:
    ...
    : it_(nh_)
  {
    ...
    image_sub_ = it_.subscribe("/image_decompressed_right", 1, &red_ball_tracker::imageCb, this);
    //image_sub_ = it_.subscribe("/camera/left/image_raw", 1, &red_ball_tracker::imageCb, this);
      
    image_pub_ = it_.advertise("/red_ball/output_video_right", 1);
  }
  ...
  void imageCb(const sensor_msgs::ImageConstPtr& msg)
  {
    ...
    /*xy_pub = nh_.advertise<geometry_msgs::PoseStamped>("red_ball/center_right", 1000);
    ...
    center_pub = nh_.advertise<red_ball::center>("red_ball/center_right", 1000);
