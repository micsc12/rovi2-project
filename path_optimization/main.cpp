...
int main(int argc, char** argv) {
    ...
    // Path 25
    {
        next_q = new Q(6, 4.43439e-17, -1.57, 2.44352e-17, -1.57, 3.55347e-17, 3.33121e-17);
        current_path.push_back(*next_q);
        next_q = new Q(6, 0.626573, -1.19098, 0.00821515, -2.19018, -0.525486, -0.273627);
        current_path.push_back(*next_q);
        next_q = new Q(6, 0.9099, -1.09735, 0.634788, -2.09465, -0.514115, 0.0220477);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.53348, -0.470772, 0.241972, -2.02425, 0.0880419, 0.283195);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.61197, -1.04479, 0.868545, -1.85327, 0.162542, 0.803735);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.69046, -1.61881, 1.49512, -1.6823, 0.237041, 1.32428);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.69567, -1.65692, 1.53672, -1.67095, 0.241987, 1.35883);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.20644, -1.03034, 1.65901, -1.19284, 0.00852728, 0.747587);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.03291, -0.631881, 1.03244, -0.951754, 0.220035, 0.44535);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.92003, -0.185517, 0.405864, -0.973427, 0.0726044, 0.315474);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.9, 0, 0, -1.6, 0, 0);
        current_path.push_back(*next_q);
    ...
    // Path 26
    {
        next_q = new Q(6, 4.43439e-17, -1.57, 2.44352e-17, -1.57, 3.55347e-17, 3.33121e-17);
        current_path.push_back(*next_q);
        next_q = new Q(6, 0.0671694, -1.44481, -0.298675, -0.943427, -0.549983, 0.524124);
        current_path.push_back(*next_q);
        next_q = new Q(6, 0.441457, -1.5506, 0.327608, -0.516355, -0.81038, 1.1507);
        current_path.push_back(*next_q);
        next_q = new Q(6, 0.627722, -0.931784, 0.954182, -0.304755, -0.9197, 1.70373);
        current_path.push_back(*next_q);
        next_q = new Q(6, 0.555875, -0.843469, 1.58075, 0.026219, -1.54011, 1.26175);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.18245, -0.415706, 1.46929, 0.214329, -1.21756, 0.659755);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.80902, 0.0120567, 1.35784, 0.402438, -0.89502, 0.0577618);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.03705, 0.167733, 1.31727, 0.470897, -0.777636, -0.161322);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.30673, 0.162752, 0.690698, 0.090634, -0.220078, -0.685418);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.11495, -0.109888, 0.410722, -0.535939, -0.359169, -1.01449);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.07158, -0.0867016, 0.498934, -1.16251, -0.227796, -0.626573);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.9, 0, 0, -1.6, 0, 0);
        current_path.push_back(*next_q);
    ...
    // Path 27
    {
        next_q = new Q(6, 4.43439e-17, -1.57, 2.44352e-17, -1.57, 3.55347e-17, 3.33121e-17);
        current_path.push_back(*next_q);
        next_q = new Q(6, 0.626573, -1.78495, 0.460512, -1.00477, 0.144826, -0.287651);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.25315, -1.45252, 0.502488, -0.606669, -0.293613, -0.0373916);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.21198, -1.32468, 1.12906, -0.0380501, -0.755492, 0.548194);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.49285, -0.947833, 1.72964, 0.588523, -0.933823, -0.0468889);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.0868, -0.709789, 1.73794, -0.0380501, -1.25623, 0.052563);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.68075, -0.471745, 1.74624, -0.664623, -1.57863, 0.152015);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.8139, -0.418383, 1.7481, -0.80508, -1.6509, 0.174309);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.37651, -0.258897, 1.12153, -0.868179, -1.61296, 0.453948);
    ...
    // Path 28
    {
        next_q = new Q(6, 4.43439e-17, -1.57, 2.44352e-17, -1.57, 3.55347e-17, 3.33121e-17);
        current_path.push_back(*next_q);
        next_q = new Q(6, 0.626573, -1.02721, -0.119257, -1.38126, -0.0253238, -0.104653);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.25315, -0.484424, -0.238514, -1.19251, -0.0506476, -0.209307);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.8335, -0.916599, 0.388059, -1.47965, -0.59149, -0.374906);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.12403, -1.42565, 0.298019, -1.51151, -1.16325, 0.251667);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.91018, -1.34402, 0.84918, -1.70473, -1.78982, -0.154219);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.00474, -1.73525, 1.4615, -2.12365, -2.18147, 0.472354);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.04187, -1.28559, 2.08807, -1.70283, -1.91603, -0.0831518);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.02771, -1.15732, 1.87972, -1.69257, -1.72485, -0.0748548);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.98514, -0.771545, 1.25315, -1.66171, -1.1499, -0.0499032);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.94257, -0.385772, 0.626573, -1.63086, -0.57495, -0.0249516);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.9, 0, 0, -1.6, 0, 0);
        current_path.push_back(*next_q);
    ...
    // Path 29
    {
        next_q = new Q(6, 4.43439e-17, -1.57, 2.44352e-17, -1.57, 3.55347e-17, 3.33121e-17);
        current_path.push_back(*next_q);
        next_q = new Q(6, 0.626573, -0.945796, -0.28396, -1.97805, -0.58925, -0.162585);
        current_path.push_back(*next_q);
        next_q = new Q(6, 0.970554, -0.319223, -0.0463805, -2.25964, -0.0156253, -0.219972);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.59713, -0.668709, 0.24109, -2.28542, 0.559783, 0.104392);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.83715, -0.870891, 0.867663, -2.26408, -0.0306034, -0.357497);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.07717, -1.07307, 1.49424, -2.24274, -0.62099, -0.819385);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.18554, -1.16435, 1.77712, -2.2331, -0.887537, -1.02792);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.00732, -0.537781, 1.25315, -1.66049, -0.431962, -0.598248);
        current_path.push_back(*next_q);
        next_q = new Q(6, 2.06827, -0.461808, 0.626573, -1.17064, -0.523468, -0.527795);
        current_path.push_back(*next_q);
        next_q = new Q(6, 1.9, 0, 0, -1.6, 0, 0);
        current_path.push_back(*next_q);
...
/*  //Remove comment to generate boxplot data
    ...
    {
    Pathoptimizerr optimizer(testpath[i]);
    Pathoptimizerr optimizer2(testpath[i]);
